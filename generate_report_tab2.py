...
def generate_report(filter_df_table:pd.DataFrame, map_data_2:pd.DataFrame, bar_data_2:pd.DataFrame, pie_data_2:pd.DataFrame):
    doc = DocxTemplate("generate_report_template_tab2.docx")
